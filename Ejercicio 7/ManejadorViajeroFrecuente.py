...
class ManejadorViajeroFrecuente:
    ...
    def comparar(self, viajero, millas):
        viaj = self.buscarViajero(viajero)
        if(self.__listaViajeros[viaj] == millas):
            print('Misma cantidad de millas')
        else:
            print('No es la misma cantidad de millas')
    
    def sumarMillas(self, viajero, millas):
        viaj = self.buscarViajero(viajero)
        millas + self.__listaViajeros[viaj]
